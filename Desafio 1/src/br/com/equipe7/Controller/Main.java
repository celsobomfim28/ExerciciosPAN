...
public class Main {
    ...
    private static void menuPrincipal() throws InterruptedException {
        ...
        do {
            ...
            System.out.printf("%10s*************************************************************\n",esp);
            System.out.printf("%10s*%10s1.%5sMostrar Estoque%27s*\n",esp,esp,esp,esp);
            System.out.printf("%10s*%10s2.%5sComprar%35s*\n",esp,esp,esp,esp);
            System.out.printf("%10s*%10s3.%5sCarrinho%34s*\n",esp,esp,esp,esp);
            System.out.printf("%10s*************************************************************\n",esp);
            System.out.printf("%10sDigite uma opção 1-3, Digite 0 para sair: ",esp);
            opcao = sc.nextInt();

            switch (opcao){
                case 0: //Sair da applicação
                    System.out.printf("%10sVOLTE SEMPRE - EQUIPE MANGUAÇA AGRADECE SUA PREFERENÇA!!",esp);
                    Thread.sleep(2000);
                    System.exit(0);
                    break;
    ...
    /**
     * Pesquisa um produto no carrinho
     * @param x
     * @param compras
     * @return Produto
     */
    ...
    /**
     * Método responsável por mostrar o carrinho de compra
     * @throws InterruptedException
     */
